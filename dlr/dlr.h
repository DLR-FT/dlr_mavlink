/** @file
 *  @brief MAVLink comm protocol generated from dlr.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_DLR_H
#define MAVLINK_DLR_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_DLR.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif

#define MAVLINK_DLR_XML_HASH 7212347239950617072
...
#define MAVLINK_MESSAGE_CRCS {{0, 50, 9, 9, 0, 0, 0}, {1, 124, 31, 43, 0, 0, 0}, {2, 137, 12, 12, 0, 0, 0}, {4, 237, 14, 14, 3, 12, 13}, {5, 217, 28, 28, 1, 0, 0}, {6, 104, 3, 3, 0, 0, 0}, {7, 119, 32, 32, 0, 0, 0}, {8, 117, 36, 36, 0, 0, 0}, {11, 89, 6, 6, 1, 4, 0}, {20, 214, 20, 20, 3, 2, 3}, {21, 159, 2, 2, 3, 0, 1}, {22, 220, 25, 25, 0, 0, 0}, {23, 168, 23, 23, 3, 4, 5}, {24, 24, 30, 52, 0, 0, 0}, {25, 23, 101, 101, 0, 0, 0}, {26, 170, 22, 24, 0, 0, 0}, {27, 144, 26, 29, 0, 0, 0}, {28, 67, 16, 16, 0, 0, 0}, {29, 115, 14, 16, 0, 0, 0}, {30, 39, 28, 28, 0, 0, 0}, {31, 246, 32, 48, 0, 0, 0}, {32, 185, 28, 28, 0, 0, 0}, {33, 104, 28, 28, 0, 0, 0}, {34, 237, 22, 22, 0, 0, 0}, {35, 244, 22, 22, 0, 0, 0}, {36, 222, 21, 37, 0, 0, 0}, {37, 212, 6, 7, 3, 4, 5}, {38, 9, 6, 7, 3, 4, 5}, {39, 254, 37, 38, 3, 32, 33}, {40, 230, 4, 5, 3, 2, 3}, {41, 28, 4, 4, 3, 2, 3}, {42, 28, 2, 18, 0, 0, 0}, {43, 132, 2, 3, 3, 0, 1}, {44, 221, 4, 9, 3, 2, 3}, {45, 232, 2, 3, 3, 0, 1}, {46, 11, 2, 2, 0, 0, 0}, {47, 153, 3, 8, 3, 0, 1}, {48, 41, 13, 21, 1, 12, 0}, {49, 39, 12, 20, 0, 0, 0}, {50, 78, 37, 37, 3, 18, 19}, {51, 196, 4, 5, 3, 2, 3}, {54, 15, 27, 27, 3, 24, 25}, {55, 3, 25, 25, 0, 0, 0}, {61, 167, 72, 72, 0, 0, 0}, {62, 183, 26, 26, 0, 0, 0}, {63, 119, 181, 181, 0, 0, 0}, {64, 191, 225, 225, 0, 0, 0}, {65, 118, 42, 42, 0, 0, 0}, {66, 148, 6, 6, 3, 2, 3}, {67, 21, 4, 4, 0, 0, 0}, {69, 243, 11, 30, 1, 10, 0}, {70, 124, 18, 38, 3, 16, 17}, {73, 38, 37, 38, 3, 32, 33}, {74, 20, 20, 20, 0, 0, 0}, {75, 158, 35, 35, 3, 30, 31}, {76, 152, 33, 33, 3, 30, 31}, {77, 143, 3, 10, 3, 8, 9}, {80, 14, 4, 4, 3, 2, 3}, {81, 106, 22, 22, 0, 0, 0}, {82, 49, 39, 51, 3, 36, 37}, {83, 22, 37, 37, 0, 0, 0}, {84, 143, 53, 53, 3, 50, 51}, {85, 140, 51, 51, 0, 0, 0}, {86, 5, 53, 53, 3, 50, 51}, {87, 150, 51, 51, 0, 0, 0}, {89, 231, 28, 28, 0, 0, 0}, {90, 183, 56, 56, 0, 0, 0}, {91, 63, 42, 42, 0, 0, 0}, {92, 54, 33, 33, 0, 0, 0}, {93, 47, 81, 81, 0, 0, 0}, {100, 175, 26, 34, 0, 0, 0}, {101, 102, 32, 117, 0, 0, 0}, {102, 158, 32, 117, 0, 0, 0}, {103, 208, 20, 57, 0, 0, 0}, {104, 56, 32, 116, 0, 0, 0}, {105, 93, 62, 63, 0, 0, 0}, {106, 138, 44, 44, 0, 0, 0}, {107, 108, 64, 65, 0, 0, 0}, {108, 32, 84, 92, 0, 0, 0}, {109, 185, 9, 9, 0, 0, 0}, {110, 84, 254, 254, 3, 1, 2}, {111, 34, 16, 18, 3, 16, 17}, {112, 174, 12, 12, 0, 0, 0}, {113, 124, 36, 39, 0, 0, 0}, {114, 237, 44, 44, 0, 0, 0}, {115, 4, 64, 64, 0, 0, 0}, {116, 76, 22, 24, 0, 0, 0}, {117, 128, 6, 6, 3, 4, 5}, {118, 56, 14, 14, 0, 0, 0}, {119, 116, 12, 12, 3, 10, 11}, {120, 134, 97, 97, 0, 0, 0}, {121, 237, 2, 2, 3, 0, 1}, {122, 203, 2, 2, 3, 0, 1}, {123, 250, 113, 113, 3, 0, 1}, {124, 87, 35, 57, 0, 0, 0}, {125, 203, 6, 6, 0, 0, 0}, {126, 220, 79, 81, 3, 79, 80}, {127, 25, 35, 35, 0, 0, 0}, {128, 226, 35, 35, 0, 0, 0}, {129, 46, 22, 24, 0, 0, 0}, {130, 29, 13, 13, 0, 0, 0}, {131, 223, 255, 255, 0, 0, 0}, {132, 85, 14, 39, 0, 0, 0}, {133, 6, 18, 18, 0, 0, 0}, {134, 229, 43, 43, 0, 0, 0}, {135, 203, 8, 8, 0, 0, 0}, {136, 1, 22, 22, 0, 0, 0}, {137, 195, 14, 16, 0, 0, 0}, {138, 109, 36, 120, 0, 0, 0}, {139, 168, 43, 43, 3, 41, 42}, {140, 181, 41, 41, 0, 0, 0}, {141, 47, 32, 32, 0, 0, 0}, {142, 72, 243, 243, 0, 0, 0}, {143, 131, 14, 16, 0, 0, 0}, {144, 127, 93, 93, 0, 0, 0}, {146, 103, 100, 100, 0, 0, 0}, {147, 154, 36, 54, 0, 0, 0}, {148, 178, 60, 78, 0, 0, 0}, {149, 200, 30, 60, 0, 0, 0}, {150, 134, 42, 42, 0, 0, 0}, {151, 219, 8, 8, 3, 6, 7}, {152, 208, 4, 8, 0, 0, 0}, {153, 188, 12, 12, 0, 0, 0}, {154, 84, 15, 15, 3, 6, 7}, {155, 22, 13, 13, 3, 4, 5}, {156, 19, 6, 6, 3, 0, 1}, {157, 21, 15, 15, 3, 12, 13}, {158, 134, 14, 15, 3, 12, 13}, {160, 78, 12, 12, 3, 8, 9}, {161, 68, 3, 3, 3, 0, 1}, {162, 189, 8, 9, 0, 0, 0}, {163, 127, 28, 28, 0, 0, 0}, {164, 154, 44, 44, 0, 0, 0}, {165, 21, 3, 3, 0, 0, 0}, {166, 21, 9, 9, 0, 0, 0}, {167, 144, 22, 22, 0, 0, 0}, {168, 1, 12, 12, 0, 0, 0}, {169, 234, 18, 18, 0, 0, 0}, {170, 73, 34, 34, 0, 0, 0}, {171, 181, 66, 66, 0, 0, 0}, {172, 22, 98, 98, 0, 0, 0}, {173, 83, 8, 8, 0, 0, 0}, {174, 167
0, 0}, {537, 38, 52, 52, 0, 0, 0}, {538, 157, 34, 34, 0, 0, 0}, {539, 118, 13, 13, 0, 0, 0}, {540, 173, 57, 57, 0, 0, 0}, {541, 59, 75, 75, 0, 0, 0}, {542, 184, 27, 27, 0, 0, 0}, {543, 240, 56, 56, 0, 0, 0}, {544, 218, 45, 45, 0, 0, 0}, {545, 252, 25, 25, 0, 0, 0}, {546, 205, 57, 57, 0, 0, 0}, {547, 111, 33, 33, 0, 0, 0}, {548, 106, 12, 12, 0, 0, 0}, {9000, 113, 137, 137, 0, 0, 0}, {9005, 117, 34, 34, 0, 0, 0}, {10001, 209, 20, 20, 0, 0, 0}, {10002, 186, 41, 41, 0, 0, 0}, {10003, 4, 1, 1, 0, 0, 0}, {10004, 133, 9, 9, 0, 0, 0}, {10005, 103, 9, 9, 0, 0, 0}, {10006, 193, 4, 4, 0, 0, 0}, {10007, 71, 17, 17, 0, 0, 0}, {10008, 240, 14, 14, 0, 0, 0}, {10151, 195, 85, 85, 0, 0, 0}, {11000, 134, 51, 52, 3, 4, 5}, {11001, 15, 135, 136, 0, 0, 0}, {11002, 234, 179, 180, 3, 4, 5}, {11003, 64, 5, 5, 0, 0, 0}, {11004, 11, 232, 232, 3, 8, 9}, {11005, 93, 230, 230, 0, 0, 0}, {11010, 46, 49, 49, 0, 0, 0}, {11011, 106, 44, 44, 0, 0, 0}, {11020, 205, 16, 16, 0, 0, 0}, {11030, 144, 44, 44, 0, 0, 0}, {11031, 133, 44, 44, 0, 0, 0}, {11032, 85, 44, 44, 0, 0, 0}, {11033, 195, 37, 37, 3, 16, 17}, {11034, 79, 5, 5, 0, 0, 0}, {11035, 128, 8, 8, 3, 4, 5}, {11036, 177, 34, 34, 0, 0, 0}, {11037, 130, 28, 28, 0, 0, 0}, {11038, 47, 38, 38, 0, 0, 0}, {11039, 142, 9, 9, 0, 0, 0}, {11040, 132, 44, 44, 0, 0, 0}, {11041, 208, 44, 44, 0, 0, 0}, {11042, 201, 44, 44, 0, 0, 0}, {11043, 193, 44, 44, 0, 0, 0}, {11044, 189, 44, 44, 0, 0, 0}, {12900, 114, 44, 44, 3, 0, 1}, {12901, 254, 59, 59, 3, 30, 31}, {12902, 140, 53, 53, 3, 4, 5}, {12903, 249, 46, 46, 3, 0, 1}, {12904, 77, 54, 54, 3, 28, 29}, {12905, 49, 43, 43, 3, 0, 1}, {12915, 94, 249, 249, 3, 0, 1}, {12918, 139, 51, 51, 0, 0, 0}, {12919, 7, 18, 18, 3, 16, 17}, {12920, 20, 5, 5, 0, 0, 0}, {42000, 227, 1, 1, 0, 0, 0}, {42001, 239, 46, 46, 0, 0, 0}, {50001, 246, 32, 32, 0, 0, 0}, {50002, 181, 246, 246, 0, 0, 0}, {50003, 62, 19, 19, 0, 0, 0}, {50004, 240, 10, 10, 3, 8, 9}, {50005, 152, 6, 6, 3, 4, 5}, {52000, 13, 100, 100, 0, 0, 0}, {52001, 239, 1, 1, 0, 0, 0}}
#endif

#include "../protocol.h"

#define MAVLINK_ENABLED_DLR

// ENUM DEFINITIONS


/** @brief List of available GNSS-Systems with numbering accoring to UBLOX */
#ifndef HAVE_ENUM_UBLOX_GNSS_SYSTEM_TYPE
#define HAVE_ENUM_UBLOX_GNSS_SYSTEM_TYPE
typedef enum UBLOX_GNSS_SYSTEM_TYPE
{
   UBLOX_GNSS_SYSTEM_GPS=0, /* GNSS Sytem Type: Global Positioning System (GPS) | */
   UBLOX_GNSS_SYSTEM_SBAS=1, /* GNSS Sytem Type: Satellite-based Augmentation System (SBAS) | */
   UBLOX_GNSS_SYSTEM_GAL=2, /* GNSS Sytem Type: European Union Global Navigation Satellite System GALILEO | */
   UBLOX_GNSS_SYSTEM_CMP=3, /* GNSS Sytem Type: Chinese BeiDou Navigation Satellite System (CMP) | */
   UBLOX_GNSS_SYSTEM_QZS=5, /* GNSS Sytem Type: Quasi-Zenith Satellite System (QZSS) | */
   UBLOX_GNSS_SYSTEM_GLO=6, /* GNSS Sytem Type: Russian Federation Global Navigation Satellite System GLONASS | */
   UBLOX_GNSS_SYSTEM_TYPE_ENUM_END=7, /*  | */
} UBLOX_GNSS_SYSTEM_TYPE;
#endif

/** @brief List of GNSS message data types to be requested. */
#ifndef HAVE_ENUM_GNSS_MSG_DATA_TYPE
#define HAVE_ENUM_GNSS_MSG_DATA_TYPE
typedef enum GNSS_MSG_DATA_TYPE
{
   GNSS_PSEUDORANGE_PHASESHIFT=0, /* Request Pseudorange and Phaseshift data of available satellites. | */
   GNSS_EPHEMERIS=1, /* Request Ehemeris data of available satellites. | */
   GNSS_MSG_DATA_TYPE_ENUM_END=2, /*  | */
} GNSS_MSG_DATA_TYPE;
#endif

/** @brief List of motion conditions of a wind turbine. */
#ifndef HAVE_ENUM_WEA_MOTION_MODE
#define HAVE_ENUM_WEA_MOTION_MODE
typedef enum WEA_MOTION_MODE
{
   WEA_STOPPED=1, /* WEA turbine is stopped. | */
   WEA_STOPPING=2, /* WEA turbine is decreasing rpm in order to stop. | */
   WEA_RUNNING=3, /* WEA turbine is running normally. | */
   WEA_STARTING_UP=4, /* WEA is increasing rpm to enter normal operation. | */
   WEA_NOT_AVAILABLE=5, /* Data about the current WEA motion mode is n/a. | */
   WEA_HOIST_READY=6, /* WEA is ready for hoisting/landing maneuver. | */
   WEA_MOTION_MODE_ENUM_END=7, /*  | */
} WEA_MOTION_MODE;
#endif

/** @brief List of controller active axes flags. */
#ifndef HAVE_ENUM_CTRL_IT_FLAGS
#define HAVE_ENUM_CTRL_IT_FLAGS
typedef enum CTRL_IT_FLAGS
{
   CTRL_IT_X_AXIS=1, /* Roll axis enabled. | */
   CTRL_IT_Y_AXIS=2, /* Pitch axis enabled. | */
   CTRL_IT_Z_AXIS=3, /* Yaw axis enabled. | */
   CTRL_IT_THR_AXIS=4, /* Throttle axis enabled. | */
   CTRL_IT_FLAGS_ENUM_END=5, /*  | */
} CTRL_IT_FLAGS;
#endif

/** @brief List of main controller modes of wePilot. */
#ifndef HAVE_ENUM_WEPILOT_CTRL_MODE
#define HAVE_ENUM_WEPILOT_CTRL_MODE
typedef enum WEPILOT_CTRL_MODE
{
   WEPILOT_CTRL_MODE_WEPILOT=0, /* wePilot is in full control. | */
   WEPILOT_CTRL_MODE_EXTVEL=1, /* External velocity control mode. | */
   WEPILOT_CTRL_MODE_EXTDIRECT=2, /* External direct actuator control mode. | */
   WEPILOT_CTRL_MODE_EXTSPDOFF=3, /* External speed offset mode. | */
   WEPILOT_CTRL_MODE_INVALID=255, /* Main control mode invalid. | */
   WEPILOT_CTRL_MODE_ENUM_END=256, /*  | */
} WEPILOT_CTRL_MODE;
#endif

/** @brief List of flight modes of wePilot. */
#ifndef HAVE_ENUM_WEPILOT_FLT_MODE
#define HAVE_ENUM_WEPILOT_FLT_MODE
typedef enum WEPILOT_FLT_MODE
{
   WEPILOT_FLT_MODE_RC=0, /* Flight mode RC control. | */
   WEPILOT_FLT_MODE_MANUAL=1, /* Flight mode manual control (no RC). | */
   WEPILOT_FLT_MODE_AUTO=2, /* Flight mode automatic. | */
   WEPILOT_FLT_MODE_DEGRADED=3, /* Flight mode degraded. | */
   WEPILOT_FLT_MODE_HOME=4, /* Flight mode return to home. | */
   WEPILOT_FLT_MODE_INVALID=255, /* Flight mode invalid. | */
   WEPILOT_FLT_MODE_ENUM_END=256, /*  | */
} WEPILOT_FLT_MODE;
#endif

/** @brief List of flight phases of wePilot. */
#ifndef HAVE_ENUM_WEPILOT_FLT_PHASE
#define HAVE_ENUM_WEPILOT_FLT_PHASE
typedef enum WEPILOT_FLT_PHASE
{
   WEPILOT_FLT_PHASE_NOT_READY=0, /* Flight phase not ready. | */
   WEPILOT_FLT_PHASE_READY=16, /* Flight phase ready. | */
   WEPILOT_FLT_PHASE_FAULT=32, /* Flight phase fault. | */
   WEPILOT_FLT_PHASE_TEST=48, /* Flight phase test. | */
   WEPILOT_FLT_PHASE_TAKEOFF=64, /* Flight phase take-off. | */
   WEPILOT_FLT_PHASE_MANUAL=80, /* Flight pahse manual. | */
   WEPILOT_FLT_PHASE_WAYPOINTS=96, /* Flight phase waypoints. | */
   WEPILOT_FLT_PHASE_FIGURES=112, /* Flight phase figures. | */
   WEPILOT_FLT_PHASE_HOME=128, /* Flight phase home. | */
   WEPILOT_FLT_PHASE_LANDING=144, /* Flight phase landing. | */
   WEPILOT_FLT_PHASE_IMMEDIATE_LANDING=160, /* Flight phase immediate landing. | */
   WEPILOT_FLT_PHASE_CTRLCRASH=176, /* Flight phase termination (controlled crash). | */
   WEPILOT_FLT_PHASE_LINKLOST=192, /* Flight phase link lost. | */
   WEPILOT_FLT_PHASE_DEGRADED=208, /* Flight phase degraded. | */
   WEPILOT_FLT_PHASE_DEGRADED_LANDING=224, /* Flight phase degraded landing. | */
   WEPILOT_FLT_PHASE_SHUTDOWN_ENGINE=240, /* Flight phase shut down engine. | */
   WEPILOT_FLT_PHASE_INVALID=255, /* Flight phase invalid. | */
   WEPILOT_FLT_PHASE_ENUM_END=256, /*  | */
} WEPILOT_FLT_PHASE;
#endif

/** @brief List of flight subphases of wePilot. */
#ifndef HAVE_ENUM_WEPILOT_FLT_SUBPHASE
#define HAVE_ENUM_WEPILOT_FLT_SUBPHASE
typedef enum WEPILOT_FLT_SUBPHASE
{
   WEPILOT_FLT_SUBPHASE_IMU_AQU=0, /* Flight phase IMU aquisition. | */
   WEPILOT_FLT_SUBPHASE_GPS_AQU=1, /* Flight phase GNSS aquisition. | */
   WEPILOT_FLT_SUBPHASE_READY=16, /* Flight sub phase ready. | */
   WEPILOT_FLT_SUBPHASE_TEST_MOTORS=48, /* Flight sub phase test motors. | */
   WEPILOT_FLT_SUBPHASE_TEST_ACT=49, /* Flight sub phase test actuators. | */
   WEPILOT_FLT_SUBPHASE_TEST_LASER=50, /* Flight sub phase test laser. | */
   WEPILOT_FLT_SUBPHASE_HAND_LAUNCH=64, /* Flight sub phase hand launch. | */
   WEPILOT_FLT_SUBPHASE_CAT_LAUNCH=65, /* Flight sub pahse catapult launch. | */
   WEPILOT_FLT_SUBPHASE_STATIONARY=66, /* Flight sub phase stationary. | */
   WEPILOT_FLT_SUBPHASE_GOV_RAMP=67, /* Flight sub phase governor ramping up. | */
   WEPILOT_FLT_SUBPHASE_GOV_NOM=68, /* Flight sub phase govenor nominal. | */
   WEPILOT_FLT_SUBPHASE_NON_STATIONARY=69, /* Flight sub phase non-stationary. | */
   WEPILOT_FLT_SUBPHASE_ABORT_TAKEOFF=79, /* Flight  sub phase abort take-off. | */
   WEPILOT_FLT_SUBPHASE_CRUISE=80, /* Flight subphase cruise. | */
   WEPILOT_FLT_SUBPHASE_HOVER=81, /* Flight sub phase hover. | */
   WEPILOT_FLT_SUBPHASE_CAM_GUIDANCE=82, /* Flight sub phase camera guidance. | */
   WEPILOT_FLT_SUBPHASE_EXTERNAL_CTRL=83, /* Flight sub phase DLR external control mode. | */
   WEPILOT_FLT_SUBPHASE_GOTO_WAYPOINT=96, /* Flight sub phase go to waypoint. | */
   WEPILOT_FLT_SUBPHASE_CIRCLE_WAYPOINT=97, /* Flight sub phase link lost. | */
   WEPILOT_FLT_SUBPHASE_STOP_WAYPOINT=98, /* Flight sub phase degraded. | */
   WEPILOT_FLT_SUBPHASE_EXEC_AOI=99, /* Flight sub phase execute AOI. | */
   WEPILOT_FLT_SUBPHASE_EXEC_SFIG=100, /* Flight sub phase execute s-figure. | */
   WEPILOT_FLT_SUBPHASE_HOVER2=112, /* Flight sub phase hover. | */
   WEPILOT_FLT_SUBPHASE_CIRCLE=113, /* Flight sub phase circle/orbit. | */
   WEPILOT_FLT_SUBPHASE_HIPPO=114, /* Flight sub phase fly hippodrome. | */
   WEPILOT_FLT_SUBPHASE_SPEED=115, /* Flight sub phase high speed. | */
   WEPILOT_FLT_SUBPHASE_CRUISE2=116, /* Flight sub phase cruise . | */
   WEPILOT_FLT_SUBPHASE_TRACK_GCS=117, /* Flight sub phase track GCS. | */
   WEPILOT_FLT_SUBPHASE_HOLD=118, /* Flight sub phase hold. | */
   WEPILOT_FLT_SUBPHASE_LANDING=119, /* Flight sub phase ready. | */
   WEPILOT_FLT_SUBPHASE_WAIT_LPD_GREEN=120, /* Flight sub phase wait for landing pad to be ready. | */
   WEPILOT_FLT_SUBPHASE_GOTO_HOME=128, /* Flight sub phase go to home point. | */
   WEPILOT_FLT_SUBPHASE_CIRCLE_HOME=129, /* Flight subphase circle at home point. | */
   WEPILOT_FLT_SUBPHASE_STOP_HOME=130, /* Flight subphase stop at home point. | */
   WEPILOT_FLT_SUBPHASE_GOTO_MOVING_HOME=131, /* Flight subphase go to moving home point. | */
   WEPILOT_FLT_SUBPHASE_CIRCLE_MOVING_HOME=132, /* Flight subphase circle and moving home. | */
   WEPILOT_FLT_SUBPHASE_INFLIGHT=144, /* Flight subphase flying. | */
   WEPILOT_FLT_SUBPHASE_LANDED=145, /* Flight subphase landed. | */
   WEPILOT_FLT_SUBPHASE_INVALID=255, /* Flight subphase invalid. | */
   WEPILOT_FLT_SUBPHASE_ENUM_END=256, /*  | */
} WEPILOT_FLT_SUBPHASE;
#endif

/** @brief Indicates whether the vehicle is flying inbound/outbound/or indifferent to reference position. */
#ifndef HAVE_ENUM_PATH_BOUND_TYPE
#define HAVE_ENUM_PATH_BOUND_TYPE
typedef enum PATH_BOUND_TYPE
{
   INBOUND=0, /*  | */
   INDIFFERENT=1, /*  | */
   OUTBOUND=2, /*  | */
   PATH_BOUND_TYPE_ENUM_END=3, /*  | */
} PATH_BOUND_TYPE;
#endif

/** @brief Indicates what type of path the deviation information in PATH_INDICATOR message is referring to. */
#ifndef HAVE_ENUM_PATH_DEVIATION_TYPE
#define HAVE_ENUM_PATH_DEVIATION_TYPE
typedef enum PATH_DEVIATION_TYPE
{
   VOR=0, /*  | */
   ILS=1, /*  | */
   WAYPOINT=2, /*  | */
   RNAV=3, /*  | */
   PATH_DEVIATION_TYPE_ENUM_END=4, /*  | */
} PATH_DEVIATION_TYPE;
#endif
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_force_sensor_data.h"
#include "./mavlink_msg_aux_output.h"
#include "./mavlink_msg_controller_state.h"
#include "./mavlink_msg_gnss_pseudo_range_phase_shift.h"
#include "./mavlink_msg_gnss_epoch_time.h"
#include "./mavlink_msg_gnss_standard_ephemeris.h"
#include "./mavlink_msg_gnss_glnoass_ephemeris.h"
#include "./mavlink_msg_gnss_cmd_request_all_data.h"
#include "./mavlink_msg_gnss_cmd_request_data_list.h"
#include "./mavlink_msg_wea_info_data.h"
#include "./mavlink_msg_mqtt_command_subscribe.h"
#include "./mavlink_msg_mqtt_command_unsubscribe.h"
#include "./mavlink_msg_gnss_relative_navigation.h"
#include "./mavlink_msg_nose_boom.h"
#include "./mavlink_msg_faust_setpoints.h"
#include "./mavlink_msg_inner_loop_setpoint.h"
#include "./mavlink_msg_outer_loop_setpoint.h"
#include "./mavlink_msg_faust_ctrl_mode_status.h"
#include "./mavlink_msg_task_sequence.h"
#include "./mavlink_msg_owf_mission_status.h"
#include "./mavlink_msg_gps_gga_ntrip_data.h"
#include "./mavlink_msg_landing_geometry.h"
#include "./mavlink_msg_relative_navigation.h"
#include "./mavlink_msg_log_status_check.h"
#include "./mavlink_msg_weather_station_data.h"
#include "./mavlink_msg_hil_distance_sensor.h"
#include "./mavlink_msg_wepilot_status.h"
#include "./mavlink_msg_wepilot_vehiclestate.h"
#include "./mavlink_msg_hil_vehicle.h"
#include "./mavlink_msg_engine_status.h"
#include "./mavlink_msg_controller_reference.h"
#include "./mavlink_msg_hil_sbus2.h"
#include "./mavlink_msg_slung_load_data.h"
#include "./mavlink_msg_elmo_ctrl_status.h"
#include "./mavlink_msg_dlr_winch_status.h"
#include "./mavlink_msg_path_indicator.h"
