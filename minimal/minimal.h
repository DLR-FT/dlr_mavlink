...
#define MAVLINK_MINIMAL_XML_HASH 3679796423587714824
...
typedef enum MAV_TYPE
{
   ...
   MAV_TYPE_WEATHER_STATION=49, /* Weather Station emitting weather information | */
   MAV_TYPE_VTOL_SYNCHROPTER=50, /* Helicopter with intermeshing blades | */
   MAV_TYPE_DROGUE=51, /* Drogue device tethered behind a carrier aircraft or rotorcraft. | */
