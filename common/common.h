...
#define MAVLINK_COMMON_XML_HASH 5382463875020847874
...
/** @brief Winch actions. */
#ifndef HAVE_ENUM_DLR_WINCH_ACTIONS
#define HAVE_ENUM_DLR_WINCH_ACTIONS
typedef enum DLR_WINCH_ACTIONS
{
   MOTOR_ON=0, /* Switch the winch motor on. | */
   MOTOR_OFF=1, /* Switch the winch motor off. | */
   SET_POS_CTS=2, /* Set a specific motor position in counts. | */
   SET_VEL_CTSS=3, /* Set a specific motor velocity in counts/s. | */
   SET_CURRENT_A=4, /* Set a specific motor current in Ampere. | */
   SET_LENGTH_M=5, /* Set a specific cable length in Meters. | */
   SET_VEL_MS=6, /* Set a specific cable velocity in Meters per Second. | */
   SET_FORCE_N=7, /* Set a specific cable force in Newton. | */
   WINCH_STOP=8, /* Stop the winch at current position | */
   WINCH_DEPLOY=9, /* Wind line from retracted position to a specified position. | */
   WINCH_REEL_IN=10, /* Return the reel to the fully retracted position. Only action and instance command parameters are used, others are ignored. | */
   WINCH_FREEWHEEL=11, /* Allow motor to freewheel. | */
   WINCH_PROFILE_POSITION=12, /* Switch winch control profile to position mode. | */
   WINCH_PROFILE_VELOCITY=13, /* Switch winch control profile to velocity mode. | */
   WINCH_PROFILE_CURRENT=14, /* Switch winch control profile to current mode. | */
   DLR_WINCH_ACTIONS_ENUM_END=15, /*  | */
} DLR_WINCH_ACTIONS;
#endif
...
typedef enum MAV_SENSOR_ORIENTATION
{
   ...
   MAV_SENSOR_ROTATION_PITCH_90_YAW_180=41, /* Pitch: 90, Yaw: 180 | */
